...
public class RobinHoodHash<K, V> {
     ...
     * 
     * Os números primos são escolhidos para melhor distribuir os dados entre os buckets (acoplementos de elemento) de hash. 
     * Se a distribuição de entradas é aleatória e uniformemente distribuídos, 
     * em seguida, a escolha do código hash / módulo não importa. 
     * Tem apenas um impacto quando existe um certo padrão para as entradas.
     * 
     * */
