...
public class AppMain {	
	static String xi = null; // Variável com intuito de pegar o ultimo nó/vértices com filhos
    ...
    /**
     * A solução é basicamente implementar a bfs para mapear a profundidade dos elementos no grafo
     * apos esse mapeamento são feitos calculos para se ter o resultado esperado
     * que é em quantas horas uma informacao demora para se tornar viral no grafo de horas.
     * 
     */
